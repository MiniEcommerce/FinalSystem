    ...
    <div class="col m4">
      <div class="card h-100 grey darken-3">
        <div class="card-image waves-effect waves-block waves-light">
          ...
          <span class="card-title">Call Of Duty: Modern Warefare</span>
        </div>
        <div class="card-content yellow-text text-yellow lighten-2">
          ...
          <div class="card-reveal grey darken-3">
              <span class="card-title yellow-text text-yellow lighten-2">Call Of Duty: Modern Warefare<i class="material-icons right">X</i></span>
                 <p>Developer: Infinity Ward</p>
                 <p>Publisher:  Activision</p>
                 <p>Writers: Brian Bloom, Justin Harris, Taylor Kurosaki, Ben Chaney</p>
                 <p>Composer: Sarah Schachner</p>
                 <p>Series:  Call of Duty</p>
                 <p>Engine:  IW 8.0</p>
                 <p>Platforms: Microsoft Windows, PlayStation 4, Xbox One</p>
                 <p>Release: October 25, 2019</p>
...
<!--ABOUT-->
  <div class="row about">
    <div class="container-fluid">
      <div class="col">
        <img src="IMG/zhan-zhang-6gS4AwmKKDg-unsplash.jpg" alt="" width="600" height="600">
      </div>
...
<!--TEAM-->
  ...
  <div class="row footer">
    <div class="col">
      <h4>Joshua Concepcion</h4>
      <p>Programmer</p>
    </div>
    <div class="col">
      <h4>Rey Vincent Dolz</h4>
      <p>Programmer</p>
    </div>
    <div class="col">
      <h4>Eudes Augustine Silerio</h4>
      <p>Designer</p>
    </div>
  </div>
<!--TEAM-->
